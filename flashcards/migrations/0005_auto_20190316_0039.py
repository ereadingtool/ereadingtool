# Generated by Django 2.1.5 on 2019-03-16 00:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_flashcard', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='session', to='flashcards.StudentFlashcard')),
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='flashcard_session', to='user.Student')),
            ],
            options={
                'abstract': False,
            },

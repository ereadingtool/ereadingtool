													...
													return A2(
														...
														function (csrftoken) {
															return A2(
																...
																function (menu_items) {
																	return _elm_lang$core$Json_Decode$succeed(
																		{flashcard_ws_addr: flashcard_ws_addr, profile_id: profile_id, instructor_profile: instructor_profile, profile_id: profile_id, profile_type: profile_type, student_profile: student_profile, csrftoken: csrftoken, menu_items: menu_items});
																},
																A2(
																	_elm_lang$core$Json_Decode$field,
																	'menu_items',

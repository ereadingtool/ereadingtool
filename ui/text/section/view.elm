module Text.View exposing (view_text_section_components)
...
view_text_section_components : (Msg -> msg) -> TextComponentGroup -> List TextDifficulty -> Html msg
view_text_section_components msg text_section_components text_difficulties =
    Html.div [attribute "class" "texts"]
    <| List.foldr (++) []
    <| Array.toList
    <| Array.map (view_text_component msg text_difficulties) (Text.Section.Component.Group.toArray text_section_components)

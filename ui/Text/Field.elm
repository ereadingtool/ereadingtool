...
type TextTitle
    = TextTitle TextFieldAttributes


type TextIntro
    = TextIntro TextFieldAttributes


type TextTags
    = TextTags TextFieldAttributes


type TextAuthor
    = TextAuthor TextFieldAttributes


type TextSource
    = TextSource TextFieldAttributes


type TextDifficulty
    = TextDifficulty TextFieldAttributes


type TextConclusion
    = TextConclusion TextFieldAttributes


type TextFields
    = TextFields TextTitle TextIntro TextTags TextAuthor TextSource TextDifficulty TextConclusion


update_error : ( String, String ) -> TextFields -> TextFields
update_error ( field_id, field_error ) ((TextFields (TextTitle title_attrs) (TextIntro intro_attrs) (TextTags tags_attrs) (TextAuthor author_attrs) (TextSource source_attrs) (TextDifficulty difficulty_attrs) (TextConclusion conclusion_attrs)) as text_fields) =
    let
...
text_title_attrs (TextTitle attrs) =
    attrs
...
text_intro_attrs (TextIntro attrs) =
    attrs
...
text_tags_attrs (TextTags attrs) =
    attrs
...
text_author_attrs (TextAuthor attrs) =
    attrs
...
text_source_attrs (TextSource attrs) =
    attrs
...
text_conclusion_attrs (TextConclusion attrs) =
    attrs
...
set_tags (TextFields text_title text_intro text_tags text_author text_source text_difficulty text_conclusion) field_attrs =
...
set_author (TextFields text_title text_intro text_tags text_author text_source text_difficulty text_conclusion) field_attrs =
...
set_source (TextFields text_title text_intro text_tags text_author text_source text_difficulty text_conclusion) field_attrs =
...
set_difficulty (TextFields text_title text_intro text_tags text_author text_source text_difficulty text_conclusion) field_attrs =

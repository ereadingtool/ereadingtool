...
type StudentFlashcards = StudentFlashcards StudentProfile Text.Translations.Decode.Flashcards
...
flashcards (StudentFlashcards profile flashcards) = flashcards
...
removeFlashcard (StudentFlashcards profile flashcards) text_word =
  let
    phrase = TextReader.TextWord.phrase text_word
    new_flashcards = Dict.remove phrase flashcards
  in

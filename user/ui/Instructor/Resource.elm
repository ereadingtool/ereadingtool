...
type InstructorProfileURI = InstructorProfileURI URI
type InstructorLogoutURI = InstructorLogoutURI URI
type InstructorInviteURI = InstructorInviteURI URI
...
instructorProfileURI (InstructorProfileURI uri) = uri
...
instructorInviteURI (InstructorInviteURI uri) = uri

module Main exposing (Flags, Model, Msg(..), flagsToForgotPassURI, forgot_pass_encoder, init, login_label, main, post_forgot_pass, subscriptions, update, view, view_content, view_email_input, view_errors, view_resp, view_submit)

...
var _user$project$Main$view_content = function (model) {
	var flashcards = _user$project$Student_Profile$studentFlashcards(model.profile);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'flashcards', _1: true},
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {flags: a, profile: b, err_str: c, errors: d};
	});
		...
		switch (_p0.ctor) {
			...
			case 'Logout':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A3(_user$project$Student_Profile$logout, model.profile, model.flags.csrftoken, _user$project$Main$LoggedOut)
				};
			default:
				if (_p0._0.ctor === 'Ok') {
					return {
					...
					var _p1 = A2(_elm_lang$core$Debug$log, 'log out error', _p0._0._0);
...
var _user$project$Main$init = function (flags) {
	return {
		...
		_1: A2(_user$project$User_Profile$retrieve_student_profile, _user$project$Main$RetrieveStudentProfile, flags.profile_id)
	};
};

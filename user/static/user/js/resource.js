...
Elm['Student']['Resource'] = Elm['Student']['Resource'] || {};
if (typeof _user$project$Student_Resource$main !== 'undefined') {
    _user$project$Student_Resource$main(Elm['Student']['Resource'], 'Student.Resource', undefined);
}

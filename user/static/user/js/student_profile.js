...
var _user$project$Main$view_student_text_readings = function (student_profile) {
	var text_readings = A2(
		_elm_lang$core$Maybe$withDefault,
		{ctor: '[]'},
		_user$project$Student_Profile_Model$studentTextReading(student_profile));
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		switch (_p6.ctor) {
			case 'RetrieveStudentProfile':
				if (_p6._0.ctor === 'Ok') {
					...
					var new_username_update = _elm_lang$core$Native_Utils.update(
						username_update,
						{
							username: _user$project$Student_Profile_Model$studentUserName(_p7)
						});
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{profile: _p7, username_update: new_username_update}),
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								err_str: _elm_lang$core$Basics$toString(_p6._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'UpdateUsername':
				...
				return {
					...
					_1: A2(_user$project$Main$validate_username, model.flags.csrftoken, _p8)
				};
			case 'ValidUsername':
				if (_p6._0.ctor === 'Ok') {
					return {
					...
					switch (_p9.ctor) {
						...
						case 'BadPayload':
							var _p11 = A2(_elm_lang$core$Debug$log, 'bad payload', _p9._0);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						default:
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
			...
			case 'UpdateDifficulty':
				var _p12 = _p6._0;
				var new_difficulty_preference = {ctor: '_Tuple2', _0: _p12, _1: _p12};
			...
			default:
				if (_p6._0.ctor === 'Ok') {
					...
					var _p17 = A2(_elm_lang$core$Debug$log, 'log out error', _p6._0._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
		}
	});
...
var _user$project$Main$view_username = function (model) {
	var username_msgs = function () {
		var _p18 = model.username_update.msg;
		if (_p18.ctor === 'Just') {
			return {
				ctor: '::',
				_0: A2(
	...
	var username_valid_attrs = function () {
		var _p19 = model.username_update.valid;
		if (_p19.ctor === 'Just') {
			var _p20 = _p19._0;
			if (_p20 === true) {
				return {
	...
	return A2(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: function () {
					var _p21 = A2(_elm_lang$core$Dict$member, 'username', model.editing);
					if (_p21 === false) {
						return A2(
							_elm_lang$html$Html$span,
							{
...
var _user$project$Main$view_difficulty = function (model) {
	var pref = function () {
		var _p22 = _user$project$Student_Profile_Model$studentDifficultyPreference(model.profile);
		if (_p22.ctor === 'Just') {
			return _elm_lang$core$Tuple$first(_p22._0);
		} else {
			return '';
		}
	}();
							...
							function (_p23) {
								...
								return A2(
									...
									A2(
										...
										{
											ctor: '::',
											_0: A2(_elm_lang$html$Html_Attributes$attribute, 'value', _p25),
											_1: {ctor: '[]'}
										},
										_elm_lang$core$Native_Utils.eq(_p25, pref) ? {
											ctor: '::',
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(_p24._1),
										_1: {ctor: '[]'}
									});
							},

...
var _user$project$Student_Profile_Encode$profileEncoder = function (student) {
	var username = _elm_lang$core$Json_Encode$string(
		_user$project$Student_Profile$studentUserName(student));
	var encode_pref = function () {
		var _p0 = _user$project$Student_Profile$studentDifficultyPreference(student);
		if (_p0.ctor === 'Just') {
...
var _user$project$Student_Profile_Update$toggle_username_update = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
...
var _user$project$Student_Profile_Update$put_profile = F2(
	function (csrftoken, student_profile) {
		...
		if (_p0.ctor === 'Just') {
			...
			var req = A4(
				...
				_user$project$Student_Profile$studentUpdateURI(_p0._0),
				{
					ctor: '::',
					_0: A2(_elm_lang$http$Http$header, 'X-CSRFToken', csrftoken),
					_1: {ctor: '[]'}
...
var _user$project$Student_Profile_Update$validate_username = F2(
		...
		switch (_p1.ctor) {
			case 'RetrieveStudentProfile':
				if (_p1._0.ctor === 'Ok') {
					...
					var new_username_update = _elm_lang$core$Native_Utils.update(
						username_update,
						{
							username: _user$project$Student_Profile$studentUserName(_p2)
						});
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{profile: _p2, username_update: new_username_update}),
			...
			case 'UpdateUsername':
				...
				return {
					...
					_1: A2(_user$project$Student_Profile_Update$validate_username, model.flags.csrftoken, _p3)
				};
			case 'ValidUsername':
				if (_p1._0.ctor === 'Ok') {
					return {
					...
					switch (_p4.ctor) {
						...
						case 'BadPayload':
							var _p6 = A2(_elm_lang$core$Debug$log, 'bad payload', _p4._0);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						default:
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
			...
			case 'UpdateDifficulty':
				var _p7 = _p1._0;
				var new_difficulty_preference = {ctor: '_Tuple2', _0: _p7, _1: _p7};
				...
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Student_Profile_Update$put_profile, model.flags.csrftoken, new_student_profile)
				};
			case 'ToggleUsernameUpdate':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Student_Profile_Update$toggle_username_update(model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SubmitUsernameUpdate':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{profile: profile}),
					_1: A2(_user$project$Student_Profile_Update$put_profile, model.flags.csrftoken, profile)
				};
			...
			case 'Submitted':
				if (_p1._0.ctor === 'Ok') {
					...
					var _p11 = _p1._0._0;
					var _p8 = A2(_elm_lang$core$Debug$log, 'submitted error', _p11);
					var _p9 = _p11;
					switch (_p9.ctor) {
						case 'BadStatus':
							var _p10 = A2(
			...
			case 'CloseHelp':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							help: A3(_user$project$Student_Profile_Help$setVisible, model.help, _p1._0, false)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PrevHelp':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							help: _user$project$Student_Profile_Help$prev(model.help)
						}),
					_1: _user$project$Student_Profile_Help$scrollToPrevMsg(model.help)
				};
			case 'NextHelp':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							help: _user$project$Student_Profile_Help$next(model.help)
						}),
					_1: _user$project$Student_Profile_Help$scrollToNextMsg(model.help)
				};
			case 'Logout':
				return {
					ctor: '_Tuple2',
			...
			default:
				if (_p1._0.ctor === 'Ok') {
					...
					var _p12 = A2(_elm_lang$core$Debug$log, 'log out error', _p1._0._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
		}
	});
...
var _user$project$Student_Profile_View$view_student_profile_page_link = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Student_Profile_View$view_student_profile_header = F2(
	function (model, top_level_msg) {
		return {
			ctor: '::',
			_0: A2(_user$project$Student_View$view_flashcard_menu_item, model.profile, top_level_msg),
			_1: {
				ctor: '::',
				_0: A3(
					...
					{
						ctor: '::',
						_0: _user$project$Student_Profile_View$view_student_profile_page_link(model),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Student_View$view_student_profile_logout_link, model.profile, top_level_msg),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$Student_Profile_View$view_profile_header = F2(
	function (model, top_level_msg) {
		return _elm_lang$core$Maybe$Just(
			A2(_user$project$Student_Profile_View$view_student_profile_header, model, top_level_msg));
	});
var _user$project$Student_Profile_View$view_menu = F3(
	function (model, _p0, top_level_msg) {
		var _p1 = _p0;
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Array$toList(
			...
			_user$project$Views$view_user_profile_menu_items(
				A2(_user$project$Student_Profile_View$view_profile_header, model, top_level_msg)));
	});
var _user$project$Student_Profile_View$view_header = F2(
	function (model, top_level_msg) {
		return _user$project$Views$view_header(
			A3(_user$project$Student_Profile_View$view_menu, model, _user$project$Views$menu_items, top_level_msg));
	});
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Flashcard Words'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Student_Profile_View$view_user_email = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('User E-Mail'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Student_Profile_View$view_cancel_btn = function (event_attr) {
	return A2(
...
var _user$project$Student_Profile_View$view_hint_overlay = F2(
	function (model, _p4) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id(msg_id),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$classList(
						{
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'invisible', _1: !visible},
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$Student_Profile_View$view_username_hint = function (model) {
	...
	var hint_attributes = {
		cancel_event: _elm_lang$html$Html_Events$onClick(
			_user$project$Student_Profile_Msg$CloseHelp(username_help)),
...
var _user$project$Student_Profile_View$view_my_performance_hint = function (model) {
	...
	var hint_attributes = {
		cancel_event: _elm_lang$html$Html_Events$onClick(
			_user$project$Student_Profile_Msg$CloseHelp(performance_help)),
		next_event: _elm_lang$html$Html_Events$onClick(_user$project$Student_Profile_Msg$NextHelp),
		prev_event: _elm_lang$html$Html_Events$onClick(_user$project$Student_Profile_Msg$PrevHelp),
		addl_attributes: {
			ctor: '::',
...
var _user$project$Student_Profile_View$view_student_performance = function (model) {
	...
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Student_Profile_View$view_my_performance_hint(model),
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$span,
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('My Performance: '),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$Student_Profile_View$view_username_menu_item_hint = function (model) {
	var username_menu_item_help = _user$project$Student_Profile_Help$username_menu_item_help;
	var hint_attributes = {
		cancel_event: _elm_lang$html$Html_Events$onClick(
			_user$project$Student_Profile_Msg$CloseHelp(username_menu_item_help)),
		next_event: _elm_lang$html$Html_Events$onClick(_user$project$Student_Profile_Msg$NextHelp),
		prev_event: _elm_lang$html$Html_Events$onClick(_user$project$Student_Profile_Msg$PrevHelp),
		addl_attributes: {
			ctor: '::',
...
var _user$project$Student_Profile_View$view_username_submit = function (username) {
	var cancel_btn = A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$Student_Profile_Msg$CancelUsernameUpdate),
				_1: {ctor: '[]'}
			}
		},
		{
					...
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$span,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Student_Profile_Msg$SubmitUsernameUpdate),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _user$project$Student_Profile_View$view_username = function (model) {
	...
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Student_Profile_View$view_username_hint(model),
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$span,
						...
						if (_p12 === false) {
										...
										_0: A2(
											_elm_lang$html$Html$div,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_user$project$Student_Profile_Msg$ToggleUsernameUpdate),
														_1: {ctor: '[]'}
													}
												}
											},
							...
							return A2(
								...
								A2(
													...
													_1: {
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onInput(_user$project$Student_Profile_Msg$UpdateUsername),
																	_1: {ctor: '[]'}
																}
															}
														}
									...
									_user$project$Student_Profile_View$view_username_submit(model.username_update)));
						}
					}(),
					_1: {ctor: '[]'}
				}
...
var _user$project$Student_Profile_View$view_help_text_for_difficulty = function (text_difficulty) {
	...
	var default_list = A2(
		...
		function (_p13) {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('difficulty_desc'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			if (_p16.ctor === 'Just') {
				...
				return A2(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(default_msg),
							_1: {ctor: '[]'}
						},
						default_list));
			}
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('difficulty_descs'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Student_Profile_View$view_scores = function (score) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Student_Profile_View$view_difficulty = function (model) {
	var pref = _elm_lang$core$Tuple$first(
		A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '_Tuple2', _0: '', _1: ''},
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_user$project$Student_Profile_Msg$UpdateDifficulty),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						A2(
							...
							_user$project$Student_Profile$studentDifficulties(model.profile))),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$Student_Profile_View$view_preferred_difficulty = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_user$project$Student_Profile_View$view_header, model, _user$project$Student_Profile_Msg$Logout),
			_1: {
				ctor: '::',
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Main$init, view: _user$project$Main$view, subscriptions: _user$project$Main$subscriptions, update: _user$project$Student_Profile_Update$update})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (csrftoken) {
			return A2(

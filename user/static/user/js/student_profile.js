...
var _user$project$Text_Model$emptyText = {id: _elm_lang$core$Maybe$Nothing, title: 'title', created_dt: _elm_lang$core$Maybe$Nothing, modified_dt: _elm_lang$core$Maybe$Nothing, source: 'source', difficulty: '', author: 'author', question_count: 0, body: 'text'};
var _user$project$Text_Model$Text = F9(
...
var _user$project$Main$post_profile = F2(
	function (csrftoken, profile) {
		var encoded_profile = _user$project$Main$profileEncoder(profile);
		var req = A4(
			_user$project$HttpHelpers$post_with_headers,
			_user$project$Config$student_api_endpoint,
			{
				ctor: '::',
		...
		{ctor: '[]'},
		{
			...
			_0: _user$project$Views$view_header(
				_elm_lang$core$Maybe$Just(
					_user$project$Profile$view_student_profile_header(model.profile))),
			_1: {
				ctor: '::',

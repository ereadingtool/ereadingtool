...
Elm['Student']['Flags'] = Elm['Student']['Flags'] || {};
if (typeof _user$project$Student_Flags$main !== 'undefined') {
    _user$project$Student_Flags$main(Elm['Student']['Flags'], 'Student.Flags', undefined);
}

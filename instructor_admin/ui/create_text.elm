...
update msg model = case msg of
    ...
    ToggleEditable text_field editable ->
      case text_field of
        Title text_title ->
            ({ model | text_component = Text.Component.set_title_editable model.text_component editable }
          , Text.Field.post_toggle_title text_title)
        Intro text_intro ->
            ({ model | text_component = Text.Component.set_intro_editable model.text_component editable }
          , Text.Field.post_toggle_intro text_intro)
        _ ->
            (model, Cmd.none)

...
var _user$project$Text_Translations$Flags = F3(
	function (a, b, c) {
		return {add_as_text_word_endpoint_url: a, group_word_endpoint_url: b, csrftoken: c};
	});
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {texts: a, profile: b, menu_items: c, flags: d, loading: e};
	});
									...
									return A2(
										...
										function (csrftoken) {
											return A2(
												...
												function (menu_items) {
													return _elm_lang$core$Json_Decode$succeed(
														{instructor_profile: instructor_profile, profile_id: profile_id, profile_type: profile_type, student_profile: student_profile, csrftoken: csrftoken, menu_items: menu_items});
												},
												A2(
													_elm_lang$core$Json_Decode$field,
													'menu_items',

...
var _user$project$Text_Definitions$Meaning = F2(
	function (a, b) {
		return {language: a, text: b};
	});

var _user$project$Main$view_meaning = function (meaning) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], ' :', meaning.text)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'(',
								A2(_elm_lang$core$Basics_ops['++'], meaning.language, ')'))),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$view_word_definition = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
				...
				_0: function () {
					...
					if (_p2.ctor === 'Just') {
						return A2(
							_elm_lang$html$Html$div,
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, _user$project$Main$view_meaning, _p2._0));
					} else {
						return A2(
							_elm_lang$html$Html$div,
							{ctor: '[]'},
...
var _user$project$Main$view_content = function (model) {
	return A2(
		...
		A2(
			_elm_lang$core$List$map,
			_user$project$Main$view_word_definition,
			_elm_lang$core$Dict$toList(model.definitions)));
};
...
var _user$project$Main$init = function (flags) {
	return {
		...
		_0: {
			flags: flags,
			definitions: _elm_lang$core$Dict$fromList(flags.words),
...
var _user$project$Main$Flags = F4(
	function (a, b, c, d) {
		return {csrftoken: a, instructor_profile: b, word_frequencies: c, words: d};
	});
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {flags: a, definitions: b, profile: c};
	});
		...
		if (_p3.ctor === 'LogOut') {
			...
			if (_p3._0.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Ports$redirect(_p3._0._0.redirect)
				};
			} else {
					...
					return A2(
						...
						function (word_frequencies) {
							return A2(
								...
								function (words) {
									return _elm_lang$core$Json_Decode$succeed(
										{csrftoken: csrftoken, instructor_profile: instructor_profile, word_frequencies: word_frequencies, words: words});
								},
								A2(

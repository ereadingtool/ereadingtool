...
var _user$project$Quiz_Field$post_toggle_title = function (_p0) {
	var _p1 = _p0;
	return _user$project$Ports$selectAllInputText(_p1._0.id);
};
var _user$project$Quiz_Field$post_toggle_intro = function (_p2) {
	var _p3 = _p2;
	var _p4 = _p3._0;
	return _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: _user$project$Ports$ckEditor(_p4.id),
			_1: {
				ctor: '::',
				_0: _user$project$Ports$addClassToCKEditor(
					{ctor: '_Tuple2', _0: _p4.id, _1: 'quiz_introduction'}),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Quiz_Field$tag_error = function (_p5) {
	var _p6 = _p5;
	return _p6._0.error;
};
var _user$project$Quiz_Field$title_error = function (_p7) {
	var _p8 = _p7;
	return _p8._0.error;
};
var _user$project$Quiz_Field$title_id = function (_p9) {
	var _p10 = _p9;
	return _p10._0.id;
};
var _user$project$Quiz_Field$title_editable = function (_p11) {
	var _p12 = _p11;
	return _p12._0.editable;
};
var _user$project$Quiz_Field$intro_id = function (_p13) {
	var _p14 = _p13;
	return _p14._0.id;
};
var _user$project$Quiz_Field$intro_editable = function (_p15) {
	var _p16 = _p15;
	return _p16._0.editable;
};
var _user$project$Quiz_Field$intro_error = function (_p17) {
	var _p18 = _p17;
	return _p18._0.error;
};
var _user$project$Quiz_Field$tags = function (_p19) {
	var _p20 = _p19;
	return _p20._2;
};
var _user$project$Quiz_Field$title = function (_p21) {
	var _p22 = _p21;
	return _p22._0;
};
var _user$project$Quiz_Field$intro = function (_p23) {
	var _p24 = _p23;
	return _p24._1;
};
...
var _user$project$Quiz_Field$QuizFields = F3(
	function (a, b, c) {
		return {ctor: 'QuizFields', _0: a, _1: b, _2: c};
	});
var _user$project$Quiz_Field$set_intro = F2(
	function (_p25, field_attrs) {
		var _p26 = _p25;
		return A3(
...
var _user$project$Quiz_Field$init_quiz_fields = A3(
	_user$project$Quiz_Field$QuizFields,
...
var _user$project$Text_Component$set_question = F2(
	function (_p33, question_field) {
		...
		return A4(
			...
			_p34._1,
			_p34._2,
			A3(_elm_lang$core$Array$set, question_index, question_field, _p34._3));
	});
	...
	function (text_component, answer_field) {
		...
		if (_p35.ctor === 'Just') {
			return A2(
				...
				text_component,
				A2(_user$project$Question_Field$set_answer_correct, _p35._0, answer_field));
		} else {
	...
	function (text_component, answer_field, feedback) {
		...
		if (_p36.ctor === 'Just') {
			return A2(
				_user$project$Text_Component$set_question,
				text_component,
				A3(_user$project$Question_Field$set_answer_feedback, _p36._0, answer_field, feedback));
		} else {
			return text_component;
		}
	});
...
var _user$project$Text_Component$set_answer = F2(
	function (_p37, answer_field) {
		...
		return A4(
			...
			_p38._1,
			_p38._2,
			A2(_user$project$Question_Field$set_answer_field, _p38._3, answer_field));
	});
...
var _user$project$Text_Component$set_text = F3(
	function (_p39, field_name, value) {
		var _p40 = _p39;
		var _p45 = _p40._0;
		var _p44 = _p40._3;
		var _p43 = _p40._2;
		...
		switch (_p41) {
			...
			case 'body':
				return A4(
					...
					_p44);
			default:
				return A4(_user$project$Text_Component$TextComponent, _p45, _p42, _p43, _p44);
		}
	});
var _user$project$Text_Component$set_field = F2(
	function (_p46, new_text_field) {
		var _p47 = _p46;
		var _p52 = _p47._0;
		var _p51 = _p47._3;
		var _p50 = _p47._2;
		var _p49 = _p47._1;
		var _p48 = new_text_field.name;
		switch (_p48) {
			case 'title':
				return A4(
					_user$project$Text_Component$TextComponent,
...
var _user$project$Text_Component$update_errors = F2(
	function (_p54, _p53) {
		...
		var _p61 = _p56._0;
		var _p60 = _p56._1;
		var error_key = A2(_elm_lang$core$String$split, '_', _p61);
		...
		if (_p57.ctor === 'Just') {
			...
			if (A2(
				...
				var _p58 = A2(_user$project$Text_Component$get_field, _p62, _p59);
				if (_p58.ctor === 'Just') {
					return A2(
						_user$project$Text_Component$set_field,
						_p62,
						A2(_user$project$Text_Component$update_field_error, _p58._0, _p60));
				} else {
					return _p62;
				}
			} else {
...
var _user$project$Text_Component$update_question_field = F2(
	function (_p63, question_field) {
		...
		return A4(
			...
			_p64._1,
			_p64._2,
			A2(_user$project$Question_Field$update_question_field, question_field, _p64._3));
	});
var _user$project$Text_Component$delete_question_field = F2(
	function (_p65, question_field) {
		var _p66 = _p65;
		return A4(
			_user$project$Text_Component$TextComponent,
			_p66._0,
			_p66._1,
			_p66._2,
			A2(_user$project$Question_Field$delete_question_field, question_field, _p66._3));
	});
var _user$project$Text_Component$delete_selected_question_fields = function (_p67) {
	var _p68 = _p67;
	return A4(
		_user$project$Text_Component$TextComponent,
		_p68._0,
		_p68._1,
		_p68._2,
		_user$project$Question_Field$delete_selected(_p68._3));
};
var _user$project$Text_Component$add_new_question = function (_p69) {
	var _p70 = _p69;
	var _p71 = _p70._1;
	return A4(
		_user$project$Text_Component$TextComponent,
		...
		_p71,
		_p70._2,
		A2(_user$project$Question_Field$add_new_question, _p71.index, _p70._3));
};
...
var _user$project$Quiz_Component$tags = function (_p0) {
	var _p1 = _p0;
	return _p1._2;
};
...
var _user$project$Quiz_Component$text_components = function (_p3) {
	var _p4 = _p3;
	return _p4._3;
};
var _user$project$Quiz_Component$reinitialize_ck_editors = function (_p5) {
	var _p6 = _p5;
	var intro_field_id = _user$project$Quiz_Field$intro_id(
		_user$project$Quiz_Field$intro(_p6._1));
	var text_component_group = _user$project$Quiz_Component$text_components(_p6);
	return _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: _elm_lang$core$Platform_Cmd$batch(
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$Ports$ckEditorSetHtml(
							{ctor: '_Tuple2', _0: intro_field_id, _1: _p6._0.introduction}),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
...
var _user$project$Quiz_Component$quiz_fields = function (_p7) {
	var _p8 = _p7;
	return _p8._1;
};
var _user$project$Quiz_Component$quiz = function (_p9) {
	var _p10 = _p9;
	return A2(
		...
		A2(
			...
			_p10._0,
			_user$project$Text_Component_Group$toTexts(_p10._3)),
		_elm_lang$core$Maybe$Just(
			_elm_lang$core$Dict$keys(_p10._2)));
};
...
var _user$project$Quiz_Component$set_intro_editable = F2(
	function (_p11, editable) {
		var _p12 = _p11;
		var _p14 = _p12._1;
		var _p13 = _user$project$Quiz_Field$intro(_p14);
		var intro_field_attrs = _p13._0;
		var new_quiz_fields = A2(
			...
			_elm_lang$core$Native_Utils.update(
				intro_field_attrs,
				{editable: editable}));
		return A4(_user$project$Quiz_Component$QuizComponent, _p12._0, new_quiz_fields, _p12._2, _p12._3);
	});
var _user$project$Quiz_Component$set_title_editable = F2(
	function (_p15, editable) {
		var _p16 = _p15;
		var _p18 = _p16._1;
		var _p17 = _user$project$Quiz_Field$title(_p18);
		var title_field_attrs = _p17._0;
		var new_quiz_fields = A2(
			...
			_elm_lang$core$Native_Utils.update(
				title_field_attrs,
				{editable: editable}));
		return A4(_user$project$Quiz_Component$QuizComponent, _p16._0, new_quiz_fields, _p16._2, _p16._3);
	});
var _user$project$Quiz_Component$set_text_components = F2(
	function (_p19, new_components) {
		var _p20 = _p19;
		return A4(_user$project$Quiz_Component$QuizComponent, _p20._0, _p20._1, _p20._2, new_components);
	});
var _user$project$Quiz_Component$update_quiz_errors = F2(
	function (quiz_component, errors) {
		var new_text_components = A2(
			...
			errors);
		var _p21 = A2(_elm_lang$core$Debug$log, 'quiz errors', errors);
...
var _user$project$Quiz_Component$add_tag = F2(
	function (_p29, tag) {
		...
		return A4(
			...
			_p30._0,
			_p30._1,
			A3(_elm_lang$core$Dict$insert, tag, tag, _p30._2),
			_p30._3);
	});
var _user$project$Quiz_Component$remove_tag = F2(
	function (_p31, tag) {
		...
		return A4(
			...
			_p32._0,
			_p32._1,
			A2(_elm_lang$core$Dict$remove, tag, _p32._2),
			_p32._3);
	});
...
var _user$project$Quiz_Create$Flags = F4(
	function (a, b, c, d) {
		return {instructor_profile: a, csrftoken: b, quiz: c, tags: d};
	});
var _user$project$Quiz_Create$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {flags: a, mode: b, profile: c, success_msg: d, error_msg: e, quiz_component: f, text_difficulties: g, tags: h, write_locked: i};
	});
var _user$project$Quiz_Create$QuizViewParams = F8(
	function (a, b, c, d, e, f, g, h) {
		return {quiz: a, quiz_component: b, quiz_fields: c, profile: d, tags: e, write_locked: f, mode: g, text_difficulties: h};
	});
var _user$project$Quiz_Create$ReadOnlyMode = function (a) {
	return {ctor: 'ReadOnlyMode', _0: a};
};
var _user$project$Quiz_Create$CreateMode = {ctor: 'CreateMode'};
var _user$project$Quiz_Create$EditMode = {ctor: 'EditMode'};
var _user$project$Quiz_Create$Tags = function (a) {
	return {ctor: 'Tags', _0: a};
};
var _user$project$Quiz_Create$Intro = function (a) {
	return {ctor: 'Intro', _0: a};
};
var _user$project$Quiz_Create$Title = function (a) {
	return {ctor: 'Title', _0: a};
};
var _user$project$Quiz_Create$QuizDelete = function (a) {
	return {ctor: 'QuizDelete', _0: a};
};
var _user$project$Quiz_Create$ConfirmQuizDelete = function (a) {
	return {ctor: 'ConfirmQuizDelete', _0: a};
};
var _user$project$Quiz_Create$DeleteQuiz = {ctor: 'DeleteQuiz'};
var _user$project$Quiz_Create$QuizUnlocked = function (a) {
	return {ctor: 'QuizUnlocked', _0: a};
};
var _user$project$Quiz_Create$QuizLocked = function (a) {
	return {ctor: 'QuizLocked', _0: a};
};
var _user$project$Quiz_Create$ToggleLock = {ctor: 'ToggleLock'};
var _user$project$Quiz_Create$DeleteTag = function (a) {
	return {ctor: 'DeleteTag', _0: a};
};
var _user$project$Quiz_Create$AddTagInput = F2(
	function (a, b) {
		return {ctor: 'AddTagInput', _0: a, _1: b};
	});
var _user$project$Quiz_Create$ClearMessages = function (a) {
	return {ctor: 'ClearMessages', _0: a};
};
var _user$project$Quiz_Create$QuizTagsDecode = function (a) {
	return {ctor: 'QuizTagsDecode', _0: a};
};
var _user$project$Quiz_Create$QuizJSONDecode = function (a) {
	return {ctor: 'QuizJSONDecode', _0: a};
};
var _user$project$Quiz_Create$UpdateQuizIntro = function (a) {
	return {ctor: 'UpdateQuizIntro', _0: a};
};
var _user$project$Quiz_Create$UpdateQuizAttributes = F2(
	function (a, b) {
		return {ctor: 'UpdateQuizAttributes', _0: a, _1: b};
	});
var _user$project$Quiz_Create$ToggleEditable = F2(
	function (a, b) {
		return {ctor: 'ToggleEditable', _0: a, _1: b};
	});
var _user$project$Quiz_Create$TextComponentMsg = function (a) {
	return {ctor: 'TextComponentMsg', _0: a};
};
var _user$project$Quiz_Create$Updated = function (a) {
	return {ctor: 'Updated', _0: a};
};
var _user$project$Quiz_Create$Submitted = function (a) {
	return {ctor: 'Submitted', _0: a};
};
var _user$project$Quiz_Create$SubmitQuiz = {ctor: 'SubmitQuiz'};
var _user$project$Quiz_Create$UpdateTextDifficultyOptions = function (a) {
							...
							_1: {
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Events$onInput(
										function (_p0) {
											return params.msg(
												A3(_user$project$Text_Update$UpdateTextValue, params.text_component, 'title', _p0));
										}),
									_1: {
										ctor: '::',
										_0: A2(_user$project$Text_View$toggle_editable, _elm_lang$html$Html_Events$onBlur, params),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				_0: A2(
					_elm_lang$html$Html$select,
					{
						...
						_0: _elm_lang$html$Html_Events$onInput(
							function (_p1) {
								return params.msg(
									A3(_user$project$Text_Update$UpdateTextValue, params.text_component, 'difficulty', _p1));
							}),
						_1: {ctor: '[]'}
					},
					{
				...
				_elm_lang$html$Html$textarea,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onInput(
							function (_p5) {
								return params.msg(
									A3(_user$project$Text_Update$UpdateTextValue, params.text_component, 'body', _p5));
							}),
						_1: {ctor: '[]'}
					}
				},
...
var _user$project$Text_View$edit_source = function (params) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Events$onInput(
										function (_p6) {
											return params.msg(
												A3(_user$project$Text_Update$UpdateTextValue, params.text_component, 'source', _p6));
										}),
									_1: {
										ctor: '::',
										_0: A2(_user$project$Text_View$toggle_editable, _elm_lang$html$Html_Events$onBlur, params),
...
var _user$project$Text_View$edit_author = function (params) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Events$onInput(
										function (_p7) {
											return params.msg(
												A3(_user$project$Text_Update$UpdateTextValue, params.text_component, 'author', _p7));
										}),
									_1: {
										ctor: '::',
										_0: A2(_user$project$Text_View$toggle_editable, _elm_lang$html$Html_Events$onBlur, params),
...
var _user$project$Text_View$view_editable = F3(
	function (params, view, edit) {
		var _p8 = _user$project$Text_Component$editable(params.field);
		if (_p8 === true) {
			return edit(params);
		} else {
			return view(params);
...
var _user$project$Text_View$view_text_component = F3(
	function (msg, text_difficulties, text_component) {
		var difficulty_field = _user$project$Text_Component$difficulty(text_component);
		var author_field = _user$project$Text_Component$author(text_component);
		var source_field = _user$project$Text_Component$source(text_component);
		var title_field = _user$project$Text_Component$title(text_component);
		var body_field = _user$project$Text_Component$body(text_component);
								...
								_0: A2(
									...
									},
									{
										...
										_0: A3(
											...
											params(title_field),
											_user$project$Text_View$view_title,
											_user$project$Text_View$edit_title),
										_1: {
											ctor: '::',
											_0: A3(
												_user$project$Text_View$view_editable,
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Text Body'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
		...
		_0: A2(
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Quiz_Create$TextComponentMsg(_user$project$Text_Update$AddText)),
					_1: {ctor: '[]'}
				}
			},
			{
		...
		_1: {
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Quiz_Create$DeleteQuiz),
						_1: {ctor: '[]'}
					}
				},
				{
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Quiz_Create$SubmitQuiz),
								_1: {ctor: '[]'}
							}
						},
						{
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Quiz_Create$ToggleLock),
								_1: {ctor: '[]'}
							}
						}
					},
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Quiz_Create$DeleteTag(tag)),
											_1: {ctor: '[]'}
										}
									}
								}
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Quiz Tags'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(
															_user$project$Quiz_Create$AddTagInput('add_tag')),
														_1: {ctor: '[]'}
													}
												}
											}
					...
					_elm_lang$html$Html$textarea,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(
									_user$project$Quiz_Create$UpdateQuizAttributes('introduction')),
								_1: {ctor: '[]'}
							}
						}
					},
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						A2(
							_user$project$Quiz_Create$ToggleEditable,
							_user$project$Quiz_Create$Intro(quiz_intro),
							true)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$classList(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Quiz Introduction'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: function () {
						var _p2 = _user$project$Quiz_Field$intro_editable(quiz_intro);
						if (_p2 === false) {
							return A2(
								_elm_lang$html$Html$div,
								{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(
								_user$project$Quiz_Create$UpdateQuizAttributes('title')),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onBlur(
									A2(
										_user$project$Quiz_Create$ToggleEditable,
										_user$project$Quiz_Create$Title(quiz_title),
										false)),
								_1: {ctor: '[]'}
							}
						}
		...
		return A2(
			...
			},
			{
				...
				_1: {
					ctor: '::',
					_0: function () {
						var _p3 = _user$project$Quiz_Field$title_editable(quiz_title);
						if (_p3 === false) {
							return A2(
								_elm_lang$html$Html$div,
								{
...
var _user$project$Quiz_View$view_quiz_date = function (params) {
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			function () {
				var _p4 = params.quiz.modified_dt;
				if (_p4.ctor === 'Just') {
					var _p5 = params.quiz.last_modified_by;
					if (_p5.ctor === 'Just') {
						return {
							ctor: '::',
							_0: A2(
										...
										A2(
											...
											A2(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													' on ',
													_user$project$Date_Utils$month_day_year_fmt(_p4._0))))),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						};
			...
			function () {
				var _p6 = params.quiz.created_dt;
				if (_p6.ctor === 'Just') {
					var _p7 = params.quiz.created_by;
					if (_p7.ctor === 'Just') {
						return {
							ctor: '::',
							_0: A2(
										...
										A2(
											...
											A2(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													' on ',
													_user$project$Date_Utils$month_day_year_fmt(_p6._0))))),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						};
...
var _user$project$Quiz_View$view_quiz = function (params) {
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_elm_lang$html$Html_Attributes$attribute, 'id', 'quiz'),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$Basics_ops['++'],
			{
				...
				_1: {
					...
					_0: A3(
						...
						_user$project$Quiz_Create$TextComponentMsg,
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_user$project$Text_Subscriptions$subscriptions, _user$project$Quiz_Create$TextComponentMsg, model),
			_1: {
				ctor: '::',
				_0: function () {
					var _p1 = model.success_msg;
					if (_p1.ctor === 'Just') {
						return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 3, _user$project$Quiz_Create$ClearMessages);
					} else {
						return _elm_lang$core$Platform_Sub$none;
					}
				}(),
				_1: {
					ctor: '::',
					_0: _user$project$Ports$ckEditorUpdate(_user$project$Quiz_Create$UpdateQuizIntro),
					_1: {
						ctor: '::',
						_0: _user$project$Ports$confirmation(_user$project$Quiz_Create$ConfirmQuizDelete),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Main$delete_quiz = F2(
	function (csrftoken, quiz) {
		...
		if (_p2.ctor === 'Just') {
			...
			return A2(_elm_lang$http$Http$send, _user$project$Quiz_Create$QuizDelete, req);
		} else {
...
var _user$project$Main$update_quiz = F2(
	function (csrftoken, quiz) {
		...
		if (_p3.ctor === 'Just') {
			...
			return A2(_elm_lang$http$Http$send, _user$project$Quiz_Create$Updated, req);
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
var _user$project$Main$post_quiz = F2(
	function (csrftoken, quiz) {
		...
		return A2(_elm_lang$http$Http$send, _user$project$Quiz_Create$Submitted, req);
	});
var _user$project$Main$delete_lock = F2(
	function (csrftoken, quiz) {
		...
		if (_p4.ctor === 'Just') {
			...
			return A2(_elm_lang$http$Http$send, _user$project$Quiz_Create$QuizUnlocked, req);
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (csrftoken, quiz) {
		...
		if (_p5.ctor === 'Just') {
			var req = A4(
				...
				_elm_lang$http$Http$emptyBody,
				_user$project$Quiz_Decode$quizLockRespDecoder);
			return A2(_elm_lang$http$Http$send, _user$project$Quiz_Create$QuizLocked, req);
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (msg, model) {
		...
		switch (_p6.ctor) {
						...
						if (_p10 === true) {
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										...
										mode: _user$project$Quiz_Create$ReadOnlyMode(_p11),
							...
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									...
									{
										quiz_component: quiz_component,
										mode: _user$project$Quiz_Create$EditMode,
										success_msg: _elm_lang$core$Maybe$Just(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'editing \'',
					...
					case 'Title':
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									quiz_component: A2(_user$project$Quiz_Component$set_title_editable, model.quiz_component, _p23)
								}),
							_1: _user$project$Quiz_Field$post_toggle_title(_p22._0)
						};
					case 'Intro':
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									quiz_component: A2(_user$project$Quiz_Component$set_intro_editable, model.quiz_component, _p23)
								}),
							_1: _user$project$Quiz_Field$post_toggle_intro(_p22._0)
						};
					default:
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			...
			case 'QuizUnlocked':
				if (_p6._0.ctor === 'Ok') {
					...
					switch (_p24.ctor) {
						case 'BadStatus':
							var _p27 = _p24._0;
							var _p25 = A2(_elm_lang$core$Debug$log, 'update error bad status', _p27);
							var _p26 = _user$project$Quiz_Decode$decodeRespErrors(_p27.body);
							if (_p26.ctor === 'Ok') {
								var errors_str = A2(
									_elm_lang$core$String$join,
									' and ',
									_elm_lang$core$Dict$values(_p26._0));
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
						...
						case 'BadPayload':
							var _p28 = A2(_elm_lang$core$Debug$log, 'update error bad payload', _p24._1);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						default:
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
						...
						case 'BadStatus':
							...
							if (_p31.ctor === 'Ok') {
								var errors_str = A2(
									_elm_lang$core$String$join,
									' and ',
									_elm_lang$core$Dict$values(_p31._0));
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
			...
			default:
				if (_p6._0.ctor === 'Ok') {
					var _p39 = _p6._0._0;
					var _p38 = A2(_elm_lang$core$Debug$log, 'quiz delete', _p39);
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _elm_lang$navigation$Navigation$load(_p39.redirect)
					};
				} else {
					var _p46 = _p6._0._0;
					var _p40 = _p46;
					switch (_p40.ctor) {
						case 'BadStatus':
							var _p43 = _p40._0;
							var _p41 = A2(_elm_lang$core$Debug$log, 'delete quiz error bad status', _p43);
							var _p42 = _user$project$Quiz_Decode$decodeRespErrors(_p43.body);
							if (_p42.ctor === 'Ok') {
								var errors_str = A2(
									_elm_lang$core$String$join,
									' and ',
									_elm_lang$core$Dict$values(_p42._0));
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
						...
						case 'BadPayload':
							var _p44 = A2(_elm_lang$core$Debug$log, 'delete quiz error bad payload', _p40._1);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						default:
							var _p45 = A2(_elm_lang$core$Debug$log, 'delete quiz error bad payload', _p46);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				}
		}
...
var _user$project$Main$quizJSONtoComponent = function (quiz) {
	...
	if (_p47.ctor === 'Just') {
		return A2(
			_elm_lang$core$Task$attempt,
			_user$project$Quiz_Create$QuizJSONDecode,
			function () {
				var _p48 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Quiz_Decode$quizDecoder, _p47._0);
				if (_p48.ctor === 'Ok') {
					return _elm_lang$core$Task$succeed(
						_user$project$Quiz_Component$init(_p48._0));
				} else {
					return _elm_lang$core$Task$fail(_p48._0);
				}
			}());
	} else {
		return _elm_lang$core$Platform_Cmd$none;
...
var _user$project$Main$tagsToDict = function (tag_list) {
	return A2(
		_elm_lang$core$Task$attempt,
		_user$project$Quiz_Create$QuizTagsDecode,
		_elm_lang$core$Task$succeed(
			_elm_lang$core$Dict$fromList(
				A2(
					_elm_lang$core$List$map,
...
var _user$project$Main$retrieveTextDifficultyOptions = function () {
	...
	return A2(_elm_lang$http$Http$send, _user$project$Quiz_Create$UpdateTextDifficultyOptions, request);
}();
var _user$project$Main$init = function (flags) {
	return {
		...
		_0: {
			flags: flags,
			mode: _user$project$Quiz_Create$CreateMode,
			success_msg: _elm_lang$core$Maybe$Nothing,
					...
					return A2(
						...
						function (quiz) {
							return A2(
								...
								function (tags) {
									return _elm_lang$core$Json_Decode$succeed(
										{csrftoken: csrftoken, instructor_profile: instructor_profile, quiz: quiz, tags: tags});
								},
								A2(
									_elm_lang$core$Json_Decode$field,
									'tags',

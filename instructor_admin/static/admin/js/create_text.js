...
var _user$project$Text_Encode$deleteTextTranslationEncode = function (translation_id) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _user$project$Text_Encode$newTextTranslationEncoder = function (translation) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _user$project$Student_Profile_Model$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {flags: a, profile: b, editing: c, err_str: d, help_msg_visible: e, username_update: f, errors: g};
	});
...
var _user$project$Views$view_menu = F3(
	function (_p3, profile, top_level_msg) {
		var _p4 = _p3;
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Array$toList(
...
var _user$project$Views$view_header = F3(
	function (profile, selected_menu_item, top_level_msg) {
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						A3(_user$project$Views$view_menu, m_items, profile, top_level_msg)),
					_1: {ctor: '[]'}
				}
			});
	});
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {flags: a, mode: b, profile: c, success_msg: d, error_msg: e, text_component: f, text_difficulties: g, text_translations_model: h, tags: i, write_locked: j, selected_tab: k};
										};
									};
								};
							};
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('word_phrase'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Text_Translations_Update$updateTranslationAsCorrect = F3(
	function (msg, csrftoken, translation) {
		var encoded_translation = _user$project$Text_Encode$textTranslationEncoder(
			_elm_lang$core$Native_Utils.update(
				translation,
		...
		var endpoint_uri = _user$project$Config$text_translation_api_endpoint(translation.id);
		var request = A4(_user$project$HttpHelpers$put_with_headers, endpoint_uri, headers, body, _user$project$Text_Decode$textTranslationUpdateRespDecoder);
		return A2(
			_elm_lang$http$Http$send,
			function (_p1) {
				return msg(
...
var _user$project$Text_Translations_Update$postTranslation = F4(
	function (msg, csrftoken, text_word, translation_text) {
		var encoded_translation = _user$project$Text_Encode$newTextTranslationEncoder(translation_text);
		var body = _elm_lang$http$Http$jsonBody(encoded_translation);
		var headers = {
			ctor: '::',
			_0: A2(_elm_lang$http$Http$header, 'X-CSRFToken', csrftoken),
		...
		var request = A4(_user$project$HttpHelpers$post_with_headers, endpoint_uri, headers, body, _user$project$Text_Decode$textTranslationAddRespDecoder);
		return A2(
			_elm_lang$http$Http$send,
			function (_p2) {
				return msg(
					_user$project$Text_Translations_Msg$AddedTextTranslation(_p2));
			},
			request);
	});
var _user$project$Text_Translations_Update$deleteTranslation = F4(
	function (msg, csrftoken, text_word, translation) {
		var encoded_translation = _user$project$Text_Encode$deleteTextTranslationEncode(translation.id);
		var body = _elm_lang$http$Http$jsonBody(encoded_translation);
		var headers = {
			ctor: '::',
			_0: A2(_elm_lang$http$Http$header, 'X-CSRFToken', csrftoken),
		...
		var endpoint_uri = _user$project$Config$text_word_api_endpoint(text_word.id);
		var request = A4(_user$project$HttpHelpers$delete_with_headers, endpoint_uri, headers, body, _user$project$Text_Decode$textTranslationRemoveRespDecoder);
		return A2(
			_elm_lang$http$Http$send,
			function (_p3) {
				return msg(
					_user$project$Text_Translations_Msg$DeletedTranslation(_p3));
			},
			request);
	});
var _user$project$Text_Translations_Update$updateTranslation = F2(
	function (translations, translation) {
		var update = function (tr) {
			return _elm_lang$core$Native_Utils.eq(tr.id, translation.id) ? translation : tr;
		};
		return A2(_elm_lang$core$List$map, update, translations);
	});
var _user$project$Text_Translations_Update$setNoTRCorrectForContext = function (text_word) {
	var _p4 = text_word.translations;
	if (_p4.ctor === 'Just') {
		...
		return _elm_lang$core$Native_Utils.update(
			text_word,
			{
				translations: _elm_lang$core$Maybe$Just(new_translations)
			});
	} else {
		return text_word;
	}
};
var _user$project$Text_Translations_Update$removeTranslation = F2(
	function (text_word, translation) {
		var _p5 = text_word.translations;
		if (_p5.ctor === 'Just') {
			var new_translations = A2(
				_elm_lang$core$List$filter,
				function (tr) {
					return !_elm_lang$core$Native_Utils.eq(tr.id, translation.id);
				},
				_p5._0);
			return _elm_lang$core$Native_Utils.update(
				text_word,
...
var _user$project$Text_Translations_Update$addTranslation = F2(
	function (text_word, translation) {
		var new_translations = function () {
			var _p6 = text_word.translations;
			if (_p6.ctor === 'Just') {
				return _elm_lang$core$Maybe$Just(
					A2(
						_elm_lang$core$Basics_ops['++'],
		...
		switch (_p7.ctor) {
			case 'ShowLetter':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							current_letter: _elm_lang$core$Maybe$Just(_p7._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'MakeCorrectForContext':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A3(_user$project$Text_Translations_Update$updateTranslationAsCorrect, parent_msg, model.flags.csrftoken, _p7._0)
				};
			case 'UpdateTextTranslation':
				if (_p7._0.ctor === 'Ok') {
					var _p11 = _p7._0._0._0;
					var update_word = function (value) {
						var _p8 = value;
						if (_p8.ctor === 'Just') {
							var text_word = _user$project$Text_Translations_Update$setNoTRCorrectForContext(_p8._0);
							...
							if (_p9.ctor === 'Just') {
								return _elm_lang$core$Maybe$Just(
									_elm_lang$core$Native_Utils.update(
										text_word,
										{
											translations: _elm_lang$core$Maybe$Just(
												A2(_user$project$Text_Translations_Update$updateTranslation, _p9._0, _p7._0._0._1))
										}));
							} else {
								return value;
							}
					...
					var letter = A2(
						...
						1,
						_elm_lang$core$String$toUpper(_p11));
					var letter_group = A2(
						_elm_lang$core$Maybe$withDefault,
						_elm_lang$core$Dict$empty,
						A2(_elm_lang$core$Dict$get, letter, model.words));
					var new_letter_group = A3(_elm_lang$core$Dict$update, _p11, update_word, letter_group);
					...
					var new_words = A3(_elm_lang$core$Dict$update, letter, update_word_group, model.words);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					var _p12 = A2(_elm_lang$core$Debug$log, 'error decoding text translation', _p7._0._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'UpdateTextTranslations':
				if (_p7._0.ctor === 'Ok') {
					...
					var _p13 = A2(_elm_lang$core$Debug$log, 'error decoding text translations', _p7._0._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'UpdateNewTranslationForTextWord':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							new_translations: A3(_elm_lang$core$Dict$insert, _p7._0.word, _p7._1, model.new_translations)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AddNewTranslationForTextWord':
				var _p15 = _p7._0;
				var _p14 = A2(_elm_lang$core$Dict$get, _p15.word, model.new_translations);
				if (_p14.ctor === 'Just') {
					return {
						ctor: '_Tuple2',
						_0: model,
			...
			case 'AddedTextTranslation':
				if (_p7._0.ctor === 'Ok') {
					...
					var letter = A2(
						_elm_lang$core$String$left,
						1,
						_elm_lang$core$String$toUpper(_p17));
					var letter_group = A2(
						_elm_lang$core$Maybe$withDefault,
						_elm_lang$core$Dict$empty,
						A2(_elm_lang$core$Dict$get, letter, model.words));
					var _p16 = A2(_elm_lang$core$Dict$get, _p17, letter_group);
					if (_p16.ctor === 'Just') {
						var new_text_word = A2(_user$project$Text_Translations_Update$addTranslation, _p16._0, _p7._0._0._1);
						var new_letter_group = A3(_elm_lang$core$Dict$insert, _p17, new_text_word, letter_group);
						var new_words = A3(_elm_lang$core$Dict$insert, letter, new_letter_group, model.words);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
					...
					var _p18 = A2(_elm_lang$core$Debug$log, 'error decoding adding text translations', _p7._0._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'DeleteTranslation':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A4(_user$project$Text_Translations_Update$deleteTranslation, parent_msg, model.flags.csrftoken, _p7._0, _p7._1)
				};
			default:
				if (_p7._0.ctor === 'Ok') {
					var _p20 = _p7._0._0;
					var translation = _p20.translation;
					var word = _p20.word;
					var letter = A2(
						_elm_lang$core$String$left,
						1,
					...
					var letter_group = A2(
						...
						_elm_lang$core$Dict$empty,
						A2(_elm_lang$core$Dict$get, letter, model.words));
					var _p19 = A2(_elm_lang$core$Dict$get, word, letter_group);
					if (_p19.ctor === 'Just') {
						var new_text_word = A2(_user$project$Text_Translations_Update$removeTranslation, _p19._0, translation);
						var new_letter_group = A3(_elm_lang$core$Dict$insert, word, new_text_word, letter_group);
						var new_words = A3(_elm_lang$core$Dict$insert, letter, new_letter_group, model.words);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
					...
					var _p21 = A2(_elm_lang$core$Debug$log, 'error decoding deleting text translations', _p7._0._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
		}
	});
	...
	function (msg, model) {
		...
		switch (_p6.ctor) {
			...
			case 'TextTranslationMsg':
				var _p7 = A3(_user$project$Text_Translations_Update$update, _user$project$Text_Create$TextTranslationMsg, _p6._0, model.text_translations_model);
				var text_translations_model = _p7._0;
				var text_translation_cmd = _p7._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{text_translations_model: text_translations_model}),
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									success_msg: _elm_lang$core$Maybe$Just(
										A2(_elm_lang$core$Basics_ops['++'], 'Text is locked by ', _p8._0))
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'EditMode':
			...
			case 'TextJSONDecode':
				...
				if (_p9.ctor === 'Ok') {
					var _p13 = _p9._0;
					var text = _user$project$Text_Component$text(_p13);
					var _p10 = text.write_locker;
					if (_p10.ctor === 'Just') {
						var _p12 = _p10._0;
						...
						if (_p11 === true) {
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									...
									{
										text_component: _p13,
										mode: _user$project$Text_Create$ReadOnlyMode(_p12),
										error_msg: _elm_lang$core$Maybe$Just(
											A2(_elm_lang$core$Basics_ops['++'], 'READONLY: text is currently being edited by ', _p12)),
										write_locked: true
									}),
								_1: _user$project$Text_Component$reinitialize_ck_editors(_p13)
							};
						} else {
							return {
								ctor: '_Tuple2',
								...
								_1: _elm_lang$core$Platform_Cmd$batch(
									{
										ctor: '::',
										_0: _user$project$Text_Component$reinitialize_ck_editors(_p13),
										_1: {
											ctor: '::',
											_0: A2(
					...
					var _p14 = A2(_elm_lang$core$Debug$log, 'text decode error', _p9._0);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			case 'Submitted':
				if (_p6._0.ctor === 'Ok') {
					...
					switch (_p16.ctor) {
						case 'BadStatus':
							var _p17 = _user$project$Text_Decode$decodeRespErrors(_p16._0.body);
							if (_p17.ctor === 'Ok') {
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											text_component: A2(_user$project$Text_Component$update_text_errors, model.text_component, _p17._0)
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							} else {
						...
						case 'BadPayload':
							var _p18 = A2(_elm_lang$core$Debug$log, 'submit text bad payload error', _p16._1.body);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						default:
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
			...
			case 'Updated':
				if (_p6._0.ctor === 'Ok') {
					...
					switch (_p19.ctor) {
						case 'BadStatus':
							var _p22 = _p19._0;
							var _p20 = A2(_elm_lang$core$Debug$log, 'update error bad status', _p22);
							var _p21 = _user$project$Text_Decode$decodeRespErrors(_p22.body);
							if (_p21.ctor === 'Ok') {
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											text_component: A2(_user$project$Text_Component$update_text_errors, model.text_component, _p21._0)
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							} else {
						...
						case 'BadPayload':
							var _p23 = A2(_elm_lang$core$Debug$log, 'update error bad payload', _p19._1);
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						default:
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
...
var _user$project$Main$init = function (flags) {
	return {
		...
		_0: {
			...
			text_translations_model: _user$project$Text_Translations_Model$init(

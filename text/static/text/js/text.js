...
var _user$project$Main$view_quiz_introduction = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: A2(_elm_lang$html$Html_Attributes$attribute, 'id', 'quiz_intro'),
			_1: {ctor: '[]'}
		},
		_jinjor$elm_html_parser$HtmlParser_Util$toVirtualDom(
			_jinjor$elm_html_parser$HtmlParser$parse(model.quiz.introduction)));
};
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'quiz', _1: true},
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$view_quiz_introduction(model),
					_1: {
						ctor: '::',
							...
							return A2(
								...
								function (profile_type) {
									return A2(
										...
										function (quiz_id) {
											return A2(
												...
												function (student_profile) {
													return _elm_lang$core$Json_Decode$succeed(
														{csrftoken: csrftoken, instructor_profile: instructor_profile, profile_id: profile_id, profile_type: profile_type, quiz_id: quiz_id, student_profile: student_profile});
												},
												A2(
													_elm_lang$core$Json_Decode$field,
													'student_profile',
										...
										A2(_elm_lang$core$Json_Decode$field, 'quiz_id', _elm_lang$core$Json_Decode$int));
								},

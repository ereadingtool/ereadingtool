...
var _user$project$Admin_Text$textAPIEndpointURL = function (_p0) {
	var _p1 = _p0;
	return _p1._0;
};
var _user$project$Admin_Text$urlToString = function (_p2) {
	var _p3 = _p2;
	return _p3._0;
};
var _user$project$Admin_Text$textEndpointToString = function (endpoint) {
	return _user$project$Admin_Text$urlToString(
		_user$project$Admin_Text$textAPIEndpointURL(endpoint));
};
var _user$project$Admin_Text$URL = function (a) {
	return {ctor: 'URL', _0: a};
};
var _user$project$Admin_Text$TextAPIEndpoint = function (a) {
	return {ctor: 'TextAPIEndpoint', _0: a};
};
...
var _user$project$Student_Resource$studentLogoutURI = function (_p2) {
	var _p3 = _p2;
	return _p3._0;
};
var _user$project$Student_Resource$studentUsernameValidURI = function (_p4) {
	var _p5 = _p4;
	return _p5._0;
};
...
var _user$project$Student_Resource$StudentEndpointURI = function (a) {
	return {ctor: 'StudentEndpointURI', _0: a};
};
var _user$project$Student_Resource$profileIDToStudentEndpointURI = F2(
	function (student_endpoint_uri, profile_id) {
		var endpoint_uri = _user$project$Student_Resource$uriToString(
			_user$project$Student_Resource$studentEndpointURI(student_endpoint_uri));
		return _user$project$Student_Resource$StudentEndpointURI(
			_user$project$Student_Resource$URI(
				A2(
					_elm_lang$core$String$join,
					'',
					{
						...
						_1: {
							...
							_0: A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(
									_user$project$Profile$profileIDtoString(profile_id)),
								'/'),
							_1: {ctor: '[]'}
						}
					})));
...
var _user$project$Text_Translations_Word_Kind$CompoundWord = {ctor: 'CompoundWord'};
var _user$project$Text_Translations_Word_Kind$SingleWord = function (a) {
...
var _user$project$Text_Translations_TextWord$wordKindToGroup = function (word) {
	var _p8 = word;
...
var _user$project$Text_Translations_TextWord$group = function (_p9) {
	var _p10 = _p9;
	return _user$project$Text_Translations_TextWord$wordKindToGroup(_p10._6);
};
...
var _user$project$Text_Translations_TextWord$strToWordType = function (_p18) {
	var _p19 = _p18;
	var _p21 = _p19._1;
	var _p20 = _p19._0;
	switch (_p20) {
		case 'single':
			return _user$project$Text_Translations_Word_Kind$SingleWord(_p21);
		case 'compound':
			return _user$project$Text_Translations_Word_Kind$CompoundWord;
		default:
			return _user$project$Text_Translations_Word_Kind$SingleWord(_p21);
	}
};
var _user$project$Text_Translations_TextWord$grammemes = function (_p22) {
	var _p23 = _p22;
	return _p23._4;
};
var _user$project$Text_Translations_TextWord$grammemeValue = F2(
	function (text_word, grammeme_name) {
		var _p24 = _user$project$Text_Translations_TextWord$grammemes(text_word);
		if (_p24.ctor === 'Just') {
			return A2(_elm_lang$core$Dict$get, grammeme_name, _p24._0);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
...
var _user$project$TextReader_TextWord$group = function (_p9) {
	var _p10 = _p9;
	return _user$project$Text_Translations_TextWord$wordKindToGroup(_p10._5);
};
	...
	switch (_p0) {
		case 'single':
			return A2(
				...
				A2(
					_elm_lang$core$Json_Decode$map,
					_user$project$Text_Translations_Word_Kind$SingleWord,
					_elm_lang$core$Json_Decode$nullable(_user$project$Text_Translations_Decode$textGroupDetailsDecoder)));
		case 'compound':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Text_Translations_Word_Kind$CompoundWord);
		default:
...
var _user$project$Text_Search_Option$selectedOptions = function (search_options) {
	return A2(
		_elm_lang$core$List$filter,
		_user$project$Text_Search_Option$selected,
		_user$project$Text_Search_Option$options(search_options));
};
var _user$project$Text_Search_Option$SearchOption = F3(
	function (a, b, c) {
		return {ctor: 'SearchOption', _0: a, _1: b, _2: c};
	});
var _user$project$Text_Search_Option$newOption = F2(
	function (_p10, selected) {
		var _p11 = _p10;
		return A3(_user$project$Text_Search_Option$SearchOption, _p11._0, _p11._1, selected);
	});
var _user$project$Text_Search_Option$setSelected = F2(
...
var _user$project$Text_Search_Option$newOptions = function (options) {
	return _user$project$Text_Search_Option$SearchOptions(
		A2(
			...
			function (_p14) {
				var _p15 = _p14;
				return A2(
					_user$project$Text_Search_Option$newOption,
					{ctor: '_Tuple2', _0: _p15._0, _1: _p15._1},
					false);
			},
			options));
};
var _user$project$Text_Search_Option$addOption = F2(
	function (_p17, _p16) {
		var _p18 = _p17;
		var _p19 = _p16;
		return _user$project$Text_Search_Option$SearchOptions(
...
var _user$project$Text_Search_Option$listToOptions = function (options) {
...
var _user$project$Text_Search_Tag$optionsToDict = function (_p2) {
	var _p3 = _p2;
	return _user$project$Text_Search_Option$optionsToDict(_p3._1);
};
var _user$project$Text_Search_Tag$selected_options = function (_p4) {
	var _p5 = _p4;
			...
			return A2(
				...
				'',
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _user$project$Text_Search_Option$value(opt),
							_1: {ctor: '[]'}
						}
					}
				});
		},
		_user$project$Text_Search_Tag$selected_options(tag_search));
};
var _user$project$Text_Search_Tag$TagSearch = F3(
	function (a, b, c) {
		return {ctor: 'TagSearch', _0: a, _1: b, _2: c};
	});
var _user$project$Text_Search_Tag$new = F2(
	function (id, options) {
		return A3(_user$project$Text_Search_Tag$TagSearch, id, options, _user$project$Search$emptyError);
	});
var _user$project$Text_Search_Tag$select_tag = F3(
	function (_p6, tag, selected) {
		var _p7 = _p6;
		return A3(
			_user$project$Text_Search_Tag$TagSearch,
			_p7._0,
			_user$project$Text_Search_Option$dictToOptions(
				A3(
					_elm_lang$core$Dict$update,
					tag,
					function (v) {
						...
						if (_p8.ctor === 'Just') {
							return _elm_lang$core$Maybe$Just(
								A2(_user$project$Text_Search_Option$setSelected, _p8._0, selected));
						} else {
							return _elm_lang$core$Maybe$Nothing;
						}
					},
					_user$project$Text_Search_Tag$optionsToDict(_p7))),
			_p7._2);
	});
...
var _user$project$Text_Search_Difficulty$selectedOptions = function (_p2) {
	var _p3 = _p2;
	return _user$project$Text_Search_Option$selectedOptions(_p3._1);
};
var _user$project$Text_Search_Difficulty$filterParams = function (difficulty_search) {
	return A2(
		_elm_lang$core$List$map,
		function (opt) {
			return A2(
		...
		_user$project$Text_Search_Difficulty$selectedOptions(difficulty_search));
};
var _user$project$Text_Search_Difficulty$options = function (_p4) {
	var _p5 = _p4;
	return _user$project$Text_Search_Option$options(_p5._1);
};
var _user$project$Text_Search_Difficulty$DifficultySearch = F3(
	function (a, b, c) {
		return {ctor: 'DifficultySearch', _0: a, _1: b, _2: c};
	});
var _user$project$Text_Search_Difficulty$new = F2(
	function (id, options) {
		return A3(_user$project$Text_Search_Difficulty$DifficultySearch, id, options, _user$project$Search$emptyError);
	});
var _user$project$Text_Search_Difficulty$selectDifficulty = F3(
	function (_p6, difficulty, selected) {
		var _p7 = _p6;
		return A3(
			_user$project$Text_Search_Difficulty$DifficultySearch,
			_p7._0,
			_user$project$Text_Search_Option$listToOptions(
				A2(
					_elm_lang$core$List$map,
					function (opt) {
						return _elm_lang$core$Native_Utils.eq(
							_user$project$Text_Search_Option$value(opt),
							difficulty) ? A2(_user$project$Text_Search_Option$setSelected, opt, selected) : opt;
					},
					_user$project$Text_Search_Difficulty$options(_p7))),
			_p7._2);
	});

var _user$project$Text_Search_ReadingStatus$optionsToDict = function (_p0) {
	var _p1 = _p0;
	return _user$project$Text_Search_Option$optionsToDict(_p1._1);
};
var _user$project$Text_Search_ReadingStatus$selectedOptions = function (_p2) {
	var _p3 = _p2;
	return _user$project$Text_Search_Option$selectedOptions(_p3._1);
};
var _user$project$Text_Search_ReadingStatus$filterParams = function (status_search) {
	return A2(
		_elm_lang$core$List$map,
		function (opt) {
			return A2(
		...
		_user$project$Text_Search_ReadingStatus$selectedOptions(status_search));
};
var _user$project$Text_Search_ReadingStatus$options = function (_p4) {
	var _p5 = _p4;
	return _user$project$Text_Search_Option$options(_p5._1);
};
var _user$project$Text_Search_ReadingStatus$statusToValue = function (text_read_status) {
	var _p6 = text_read_status;
	switch (_p6.ctor) {
		case 'InProgress':
			return 'in_progress';
		case 'Read':
...
var _user$project$Text_Search_ReadingStatus$Unread = {ctor: 'Unread'};
var _user$project$Text_Search_ReadingStatus$Read = {ctor: 'Read'};
var _user$project$Text_Search_ReadingStatus$InProgress = {ctor: 'InProgress'};
var _user$project$Text_Search_ReadingStatus$valueToStatus = function (value) {
	var _p7 = value;
	switch (_p7) {
		case 'in_progress':
			return _user$project$Text_Search_ReadingStatus$InProgress;
		case 'read':
			return _user$project$Text_Search_ReadingStatus$Read;
		case 'unread':
			return _user$project$Text_Search_ReadingStatus$Unread;
		default:
			return _user$project$Text_Search_ReadingStatus$Unread;
	}
};
var _user$project$Text_Search_ReadingStatus$TextReadStatusSearch = F3(
	function (a, b, c) {
		return {ctor: 'TextReadStatusSearch', _0: a, _1: b, _2: c};
	});
var _user$project$Text_Search_ReadingStatus$new = F2(
	function (id, options) {
		return A3(_user$project$Text_Search_ReadingStatus$TextReadStatusSearch, id, options, _user$project$Search$emptyError);
	});
var _user$project$Text_Search_ReadingStatus$selectStatus = F3(
	function (_p8, status, selected) {
		var _p9 = _p8;
		return A3(
			_user$project$Text_Search_ReadingStatus$TextReadStatusSearch,
			_p9._0,
			_user$project$Text_Search_Option$listToOptions(
				A2(
					_elm_lang$core$List$map,
					function (opt) {
						return _elm_lang$core$Native_Utils.eq(
							_user$project$Text_Search_Option$value(opt),
							_user$project$Text_Search_ReadingStatus$statusToValue(status)) ? A2(_user$project$Text_Search_Option$setSelected, opt, selected) : opt;
					},
					_user$project$Text_Search_ReadingStatus$options(_p9))),
			_p9._2);
	});

var _user$project$Text_Search$difficultySearch = function (_p0) {
	var _p1 = _p0;
	return _p1._2;
};
var _user$project$Text_Search$statusSearch = function (_p2) {
	var _p3 = _p2;
	return _p3._3;
};
var _user$project$Text_Search$tagSearch = function (_p4) {
	var _p5 = _p4;
	return _p5._1;
};
...
var _user$project$Text_Search$tagOptionsToDict = function (text_search) {
	return _user$project$Text_Search_Tag$optionsToDict(
		_user$project$Text_Search$tagSearch(text_search));
};
var _user$project$Text_Search$TextSearch = F4(
	function (a, b, c, d) {
		return {ctor: 'TextSearch', _0: a, _1: b, _2: c, _3: d};
	});
var _user$project$Text_Search$new = F4(
...
var _user$project$Text_Search$addDifficultyToSearch = F3(
	function (text_search, difficulty, selected) {
		var new_difficulty_search = A3(
			_user$project$Text_Search_Difficulty$selectDifficulty,
			_user$project$Text_Search$difficultySearch(text_search),
			difficulty,
			selected);
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {flags: a, profile: b, menu_items: c, performance_report: d, student_endpoints: e, consenting_to_research: f, flashcards: g, editing: h, err_str: i, help: j, username_update: k, errors: l};
											};
										};
									};
								};
...
var _user$project$Student_Profile_Decode$studentConsentRespDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$Student_Profile_Model$StudentConsentResp,
	A2(_elm_lang$core$Json_Decode$field, 'consented', _elm_lang$core$Json_Decode$bool));
var _user$project$Student_Profile_Decode$studentProfileURIParamsDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'profile_uri',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'logout_uri',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Student_Profile$StudentURIParams)));
var _user$project$Student_Profile_Decode$studentProfileParamsDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'uris',
	_user$project$Student_Profile_Decode$studentProfileURIParamsDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'difficulties',
	...
	A3(
		...
		A3(
			...
			A2(
				...
				function (_p0) {
					return _elm_lang$core$Maybe$Just(
						_user$project$Student_Resource$StudentUsername(_p0));
				},
				_elm_lang$core$Json_Decode$string),
...
var _user$project$User_Profile$retrieveStudentProfile = F3(
	function (msg, profile_id, student_endpoint_uri) {
		var request = A2(
...
var _user$project$TextSearch_Help$help = function (_p0) {
	var _p1 = _p0;
	return _p1._0;
};
var _user$project$TextSearch_Help$isVisible = F2(
	function (student_profile_help, msg) {
		return A2(
			_user$project$Help_PopUp$isVisible,
			_user$project$TextSearch_Help$help(student_profile_help),
			msg);
	});
var _user$project$TextSearch_Help$scrollToNextMsg = function (student_profile_help) {
	return _user$project$Help_PopUp$scrollToNextMsg(
		_user$project$TextSearch_Help$help(student_profile_help));
};
var _user$project$TextSearch_Help$scrollToPrevMsg = function (student_profile_help) {
	return _user$project$Help_PopUp$scrollToPrevMsg(
		_user$project$TextSearch_Help$help(student_profile_help));
};
var _user$project$TextSearch_Help$scrollToFirstMsg = function (student_profile_help) {
	return _user$project$Help_PopUp$scrollToFirstMsg(
		_user$project$TextSearch_Help$help(student_profile_help));
};
var _user$project$TextSearch_Help$popupToID = function (help_popup) {
	var _p2 = help_popup;
	switch (_p2.ctor) {
		case 'DifficultyFilterHelp':
			return 'difficulty_filter_hint';
		case 'TopicFilterHelp':
			return 'topic_filter_hint';
		default:
			return 'status_filter_hint';
	}
};
var _user$project$TextSearch_Help$popupToOverlayID = function (help_popup) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$TextSearch_Help$popupToID(help_popup),
		'_overlay');
};
var _user$project$TextSearch_Help$helpMsg = function (help_msg) {
	var _p3 = help_msg;
	switch (_p3.ctor) {
		case 'DifficultyFilterHelp':
			return _p3._0;
...
var _user$project$TextSearch_Help$StatusFilterHelp = function (a) {
	return {ctor: 'StatusFilterHelp', _0: a};
};
var _user$project$TextSearch_Help$status_filter_help = _user$project$TextSearch_Help$StatusFilterHelp('As you use this site, texts will be sorted into three categories: Unread (ones that you’ve not yet read),\n     In Progress (those that you started but haven’t finished), and Previously Read (ones that you’ve read before).\n     You can access and (re)read any of these texts at any time.');
var _user$project$TextSearch_Help$TopicFilterHelp = function (a) {
	return {ctor: 'TopicFilterHelp', _0: a};
};
var _user$project$TextSearch_Help$topic_filter_help = _user$project$TextSearch_Help$TopicFilterHelp('Click on topics that interest you from this list of tags in order to see a list of texts that deal with these\n     topics.');
var _user$project$TextSearch_Help$DifficultyFilterHelp = function (a) {
	return {ctor: 'DifficultyFilterHelp', _0: a};
};
var _user$project$TextSearch_Help$difficulty_filter_help = _user$project$TextSearch_Help$DifficultyFilterHelp('The preferred difficulty that you selected on your User page is pre-selected here.\n     You can choose additional difficulty levels or deselect difficulty levels as you please.');
var _user$project$TextSearch_Help$help_msgs = {
	ctor: '::',
	_0: _user$project$TextSearch_Help$difficulty_filter_help,
	_1: {
		ctor: '::',
...
var _user$project$TextSearch_Help$TextSearchHelp = function (a) {
	return {ctor: 'TextSearchHelp', _0: a};
};
var _user$project$TextSearch_Help$init = _user$project$TextSearch_Help$TextSearchHelp(
	A3(_user$project$Help_PopUp$init, _user$project$TextSearch_Help$help_msgs, _user$project$TextSearch_Help$popupToOverlayID, _user$project$TextSearch_Help$popupToID));
var _user$project$TextSearch_Help$setVisible = F3(
	function (student_profile_help, help_msg, visible) {
		return _user$project$TextSearch_Help$TextSearchHelp(
			A3(
				_user$project$Help_PopUp$setVisible,
				_user$project$TextSearch_Help$help(student_profile_help),
				help_msg,
...
var _user$project$TextSearch_Help$next = function (student_profile_help) {
	return _user$project$TextSearch_Help$TextSearchHelp(
		_user$project$Help_PopUp$next(
			_user$project$TextSearch_Help$help(student_profile_help)));
};
var _user$project$TextSearch_Help$prev = function (student_profile_help) {
	return _user$project$TextSearch_Help$TextSearchHelp(
		_user$project$Help_PopUp$prev(
			_user$project$TextSearch_Help$help(student_profile_help)));
};
...
var _user$project$Main$view_search_results = function (text_list_items) {
	var view_search_result = function (text_item) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('search_result'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(sections_complete),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
...
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {results: a, profile: b, menu_items: c, text_search: d, text_api_endpoint: e, help: f, error_msg: g, flags: h};
	});
...
var _user$project$Main$NextHelp = {ctor: 'NextHelp'};
var _user$project$Main$PrevHelp = {ctor: 'PrevHelp'};
var _user$project$Main$CloseHelp = function (a) {
	return {ctor: 'CloseHelp', _0: a};
};
var _user$project$Main$view_topic_filter_hint = function (model) {
	var topic_filter_help = _user$project$TextSearch_Help$topic_filter_help;
	var hint_attributes = {
		id: _user$project$TextSearch_Help$popupToID(topic_filter_help),
		visible: A2(_user$project$TextSearch_Help$isVisible, model.help, topic_filter_help),
		text: _user$project$TextSearch_Help$helpMsg(topic_filter_help),
		cancel_event: _elm_lang$html$Html_Events$onClick(
			_user$project$Main$CloseHelp(topic_filter_help)),
...
var _user$project$Main$view_difficulty_filter_hint = function (model) {
	var difficulty_filter_help = _user$project$TextSearch_Help$difficulty_filter_help;
	var hint_attributes = {
		id: _user$project$TextSearch_Help$popupToID(difficulty_filter_help),
		visible: A2(_user$project$TextSearch_Help$isVisible, model.help, difficulty_filter_help),
		text: _user$project$TextSearch_Help$helpMsg(difficulty_filter_help),
		cancel_event: _elm_lang$html$Html_Events$onClick(
			_user$project$Main$CloseHelp(difficulty_filter_help)),
		next_event: _elm_lang$html$Html_Events$onClick(_user$project$Main$NextHelp),
		prev_event: _elm_lang$html$Html_Events$onClick(_user$project$Main$PrevHelp),
		addl_attributes: {
			ctor: '::',
...
var _user$project$Main$updateResults = F2(
	function (text_api_endpoint, text_search) {
		var filter_params = _user$project$Text_Search$filterParams(text_search);
		var text_api_endpoint_url = _user$project$Admin_Text$textEndpointToString(text_api_endpoint);
		var query_string = A2(
			_elm_lang$core$Basics_ops['++'],
			A2(
				_elm_lang$core$String$join,
...
var _user$project$Main$init = function (flags) {
	...
	var text_search_help = _user$project$TextSearch_Help$init;
	var text_api_endpoint = _user$project$Admin_Text$TextAPIEndpoint(
		_user$project$Admin_Text$URL(flags.text_api_endpoint_url));
	var status_search = A2(
		_user$project$Text_Search_ReadingStatus$new,
		'text_status_search',
		_user$project$Text_Search_Option$newOptions(flags.text_statuses));
	var profile = _user$project$User_Profile$initProfile(flags);
	var difficulty_search = A2(
		_user$project$Text_Search_Difficulty$new,
		'text_difficulty_search',
		_user$project$Text_Search_Option$newOptions(flags.text_difficulties));
	var tag_search = A2(
		_user$project$Text_Search_Tag$new,
		'text_tag_search',
		_user$project$Text_Search_Option$newOptions(
			A2(
				_elm_lang$core$List$map,
				function (tag) {
				...
				flags.text_tags)));
	var default_search = A4(_user$project$Text_Search$new, text_api_endpoint, tag_search, difficulty_search, status_search);
	...
	return {
		...
		_1: A2(_user$project$Main$updateResults, text_api_endpoint, text_search)
	};
};
		...
		switch (_p8.ctor) {
			case 'AddDifficulty':
				...
				return {
					...
					_1: A2(_user$project$Main$updateResults, model.text_api_endpoint, new_text_search)
				};
			case 'SelectStatus':
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$Main$updateResults, model.text_api_endpoint, new_text_search),
								_1: {ctor: '[]'}
							}
						})
				};
			...
			case 'PrevHelp':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							help: _user$project$TextSearch_Help$prev(model.help)
						}),
					_1: _user$project$TextSearch_Help$scrollToPrevMsg(model.help)
				};
			case 'NextHelp':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							help: _user$project$TextSearch_Help$next(model.help)
						}),
					_1: _user$project$TextSearch_Help$scrollToNextMsg(model.help)
				};
			case 'LogOut':
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$SelectStatus = F2(
	function (a, b) {
...
var _user$project$Main$view_statuses = function (status_search) {
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'text_status', _1: true},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'text_status_option_selected', _1: selected},
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						A2(_user$project$Main$SelectStatus, status, !selected)),
					_1: {ctor: '[]'}
				}
			},
			{
	...
	var statuses = _user$project$Text_Search_ReadingStatus$options(status_search);
	return A2(
		_elm_lang$core$List$map,
		view_status,
		A2(
							...
							_1: {
								...
								_0: A2(
									...
									_user$project$Main$view_difficulties(
										_user$project$Text_Search$difficultySearch(model.text_search))),
								_1: {ctor: '[]'}
							}
						},
						_user$project$Main$view_difficulty_filter_hint(model))),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										{
											...
											_0: _user$project$Main$view_tags(
												_user$project$Text_Search$tagSearch(model.text_search)),
											_1: {ctor: '[]'}
										},
										_user$project$Main$view_topic_filter_hint(model))),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: A3(_user$project$Views$view_authed_header, model.profile, model.menu_items, _user$project$Main$LogOut),
			_1: {
				ctor: '::',
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	...
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (text_api_endpoint_url) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				function (text_difficulties) {
					return A2(
						_elm_lang$core$Json_Decode$andThen,
						function (text_statuses) {
							return A2(
								_elm_lang$core$Json_Decode$andThen,
								function (text_tags) {
									return A2(
																			...
																			return A2(
																				...
																				function (csrftoken) {
																					return A2(
																						...
																						function (menu_items) {
																							return _elm_lang$core$Json_Decode$succeed(
																								{text_api_endpoint_url: text_api_endpoint_url, text_difficulties: text_difficulties, text_statuses: text_statuses, text_tags: text_tags, welcome: welcome, instructor_profile: instructor_profile, profile_id: profile_id, profile_type: profile_type, student_profile: student_profile, csrftoken: csrftoken, menu_items: menu_items});
																						},
																						A2(
																							_elm_lang$core$Json_Decode$field,
																							'menu_items',
		...
		A2(_elm_lang$core$Json_Decode$field, 'text_api_endpoint_url', _elm_lang$core$Json_Decode$string)));

	...
	if (_p6.ctor === 'Just') {
		...
		if (_p7.ctor === 'Just') {
			return _user$project$User_Profile$Student(
				_user$project$Student_Profile$init_profile(_p7._0));
		} else {
...
var _user$project$Menu_View$view_lower_menu_item = F4(
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'lower-menu-item-selected', _1: selected},
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
		...
		return A2(
			...
			_elm_lang$core$Array$toList(
				A2(
					...
					function (item) {
						return A4(
							_user$project$Menu_View$view_lower_menu_item,
			...
			A2(
				_elm_lang$core$Maybe$withDefault,
				{ctor: '[]'},
				A2(_user$project$User_Profile$view_profile_menu_items, profile, top_level_menu_msg)));
	});
...
var _user$project$Views$view_authed_header = F3(
	function (profile, selected_menu_item, top_level_menu_msg) {
		...
		return A2(
			_user$project$Views$view_header,
			A3(_user$project$Menu_View$view_top_menu, m_items, profile, top_level_menu_msg),
			A3(_user$project$Menu_View$view_lower_menu, m_items, profile, top_level_menu_msg));
	});
																...
																function (profile_type) {
																	return A2(
																		...
																		function (student_profile) {
																			return _elm_lang$core$Json_Decode$succeed(
																				{text_difficulties: text_difficulties, text_statuses: text_statuses, text_tags: text_tags, welcome: welcome, csrftoken: csrftoken, instructor_profile: instructor_profile, profile_id: profile_id, profile_type: profile_type, student_profile: student_profile});
																		},
																		A2(
																			_elm_lang$core$Json_Decode$field,
																			'student_profile',
																																	...
																																	return A2(
																																		...
																																		function (performance_report) {
																																			return A2(
																																				...
																																				function (username) {
																																					return _elm_lang$core$Json_Decode$succeed(
																																						{difficulties: difficulties, difficulty_preference: difficulty_preference, email: email, flashcards: flashcards, id: id, performance_report: performance_report, username: username});
																																				},
																																																...
																																																return A2(
																																																	...
																																																	function (translations) {
																																																		return A2(
																																																			...
																																																			function (word) {
																																																				return _elm_lang$core$Json_Decode$succeed(
																																																					{grammemes: grammemes, id: id, instance: instance, phrase: phrase, translations: translations, word: word});
																																																			},
																																																			A2(
																																																				_elm_lang$core$Json_Decode$field,
																																																				'word',
																																																																...
																																																																return A2(
																																																																	...
																																																																	function (length) {
																																																																		return A2(
																																																																			...
																																																																			function (pos) {
																																																																				return _elm_lang$core$Json_Decode$succeed(
																																																																					{id: id, instance: instance, length: length, pos: pos});
																																																																			},
																																																				...
																																																				_1: {
																																																					...
																																																					_0: A2(
																																																						...
																																																						_elm_lang$core$Json_Decode$list(
																																																							A2(
																																																								_elm_lang$core$Json_Decode$andThen,
																																																								function (correct_for_context) {
																																																									return A2(
																																																										_elm_lang$core$Json_Decode$andThen,
																																																										function (text) {
																																																											return _elm_lang$core$Json_Decode$succeed(
																																																												{correct_for_context: correct_for_context, text: text});
																																																										},
																																																										A2(_elm_lang$core$Json_Decode$field, 'text', _elm_lang$core$Json_Decode$string));
																																																								},
																																																								A2(_elm_lang$core$Json_Decode$field, 'correct_for_context', _elm_lang$core$Json_Decode$bool)))),
																																																					_1: {ctor: '[]'}
																																																				}
																																																			})));
																																															},
